...
//		mockMvc.perform(MockMvcRequestBuilders.post(URL).content( getJsonPayload( id, nome, cpf, data, senha, RoleEnum.ROLE_ADMIN) )
...
//	}
//	
//	private String getJsonPayload( Long idUser, String name, String cpf, Date dataNasc, String senha, RoleEnum role) 
//			throws JsonProcessingException {
//		UserDTO dto = new UserDTO( idUser, name, cpf, dataNasc, senha, role.getValue());
